...
import { Calendar, Clock, Search, ChevronLeft, ChevronRightIcon } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-6 text-center text-white">
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">{formattedCategory}</h1>
          <p className="mx-auto max-w-[700px] text-lg md:text-xl text-gray-100">
            Browse all stories related to {formattedCategory.toLowerCase()}.
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-lg mb-8">
              Subscribe to our newsletter to receive the latest {formattedCategory.toLowerCase()} stories and updates
              from the Caywood Brown Foundation.
            </p>
