...
const eventDetails: Record<string, EventData> = {
  "national-convergence-health-financing-reform": {
    title: "National Convergence on Nigeria’s Health Financing Reform Bills (SB.886 & SB.713)",
    ...
    badgeText: "National Landmark Convergence",
    lead: "Stakeholders across Nigeria’s health and public finance ecosystem converged in Abuja on Thursday, 17 September 2026, for the National Convergence on Nigeria’s Health Financing Reform Bills, organised by the Caywood Brown Foundation through the Office of the Chairman, Senate Committee on Health.",
    collaborators: [
      "Office of the Chairman, Senate Committee on Health (Senator Dr. Ipalibo Harry Banigo)",
    ...
    keyActivities: [
      "Keynote address by Coordinating Minister of Health Prof. Muhammad Ali Pate on sustainable domestic financing",
      "Executive policy direction presented by Special Adviser to the President on Health Dr. Salma Ibrahim Anas",
      "Legislative review of SB.886 (BHCPF from 1% to 2%) and SB.713 (Sugar-Sweetened Beverages Tax)",
      "National convergence communiqué unanimously adopted and transmitted to the 10th National Assembly",
    ],
    narrative: [
      "Stakeholders across Nigeria’s health and public finance ecosystem converged in Abuja on Thursday, 17 September 2026, for the National Convergence on Nigeria’s Health Financing Reform Bills, held at the Banquet Hall, Onomo Allure Abuja.",
      "The Convergence, organised by the Caywood Brown Foundation through the Office of the Chairman, Senate Committee on Health (Secondary and Tertiary), was themed: 'Strengthening Sustainable Domestic Health Financing for Universal Health Coverage: Leveraging the SSB Tax and the BHCPF'.",
      "At the centre of discussions were two critical health financing reform Bills passed by the Senate: SB. 886 (seeking to increase statutory allocation to the Basic Health Care Provision Fund from 1% to 2% of the Consolidated Revenue Fund) and SB. 713 (reforming excise duty on Sugar-Sweetened Beverages for health promotion and non-communicable disease prevention).",
      "The message from Abuja is clear: sustainable domestic health financing is critical to achieving Universal Health Coverage and ensuring that increased investment translates into better health services and improved health outcomes for Nigerians.",
    ],
  },
  "ssb-tax-breakfast-technical-session": {
    ...
    keyActivities: [
      ...
      "Deliberations on legislative pathways and consensus-building for Sugar-Sweetened Beverages taxation",
      "Analysis of domestic health financing frameworks to fund the prevention of non-communicable diseases",
      "Official commendation of the sponsor of SB.713 and the 10th National Assembly leadership",
      "Issuance of joint CBF & CAPPA policy communiqué to advance a healthier Nigeria",
    ],
    narrative: [
      ...
      "We commend the sponsor of SB.713 — Customs, Excise Tariff, etc. (Consolidation) Act (Amendment) Bill — and the 10th National Assembly for their leadership and commitment to advancing stronger health financing and public-health legislation.",
      ...
      "Together, we can advance policies that protect health, strengthen our health system, and build healthier communities across Nigeria. Stronger policies. Better health. A healthier Nigeria.",
    ],
  },
