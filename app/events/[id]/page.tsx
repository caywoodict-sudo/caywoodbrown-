...
export default function EventDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const event = allEvents.find((event) => event.id === resolvedParams.id) || {
    id: "not-found",
...
function getEventPurpose(category: string) {
  switch (category) {
    case "workshop":
...
function getAttendeesList(category: string) {
  switch (category) {
    case "workshop":
      return [
...
function getEventCapacity(category: string) {
  switch (category) {
    case "workshop":
